...
// var cityHistory0 = function() {
//     fetch("https://api.openweathermap.org/data/2.5/weather?q=" + cityNameHistory.value + "&units=imperial&appid=" + key)
//     .then(function (response) {
//         return response.json();
//     })
//     .then(function(data) {
...
// var cityHistoryCounter = document.querySelector(".city-history-btn");
// cityHistoryCounter.addEventListener("click", cityHistory0);
